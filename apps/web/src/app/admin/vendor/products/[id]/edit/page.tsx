      ...
      try {
        ...
        if (product) {
          setForm({
            ...
            description: `Premium ${product.title} sourced and prepared for the local market with consistent quality assurance.`,
  ...
  return (
    <div className="min-h-screen bg-[#f6f6f8] text-[#111318] antialiased">
      ...
      <header className="sticky top-0 z-40 flex h-16 w-full items-center justify-between bg-white/80 px-4 shadow-sm backdrop-blur-md md:ml-64 md:w-[calc(100%-16rem)] md:px-8">
        <div className="flex w-96 items-center gap-3 rounded-full bg-[#f0f2f4] px-4 py-1.5 focus-within:ring-2 focus-within:ring-[#135bec]/20">
          <Search className="text-slate-500" size={18} />
          <input
            className="w-full border-none bg-transparent text-sm outline-none ring-0 placeholder:text-slate-500"
        ...
        <div className="flex items-center gap-4">
          <button className="flex h-10 w-10 items-center justify-center text-slate-600 transition-colors hover:text-[#135bec]" type="button">
            <Bell size={18} />
          </button>
          <div className="h-8 w-px bg-slate-300/40" />
          <div className="flex items-center gap-3">
            <div className="hidden text-right sm:block">
              <p className="text-sm font-bold text-slate-900">Abebe Kebede</p>
              <p className="text-[10px] uppercase tracking-tighter text-slate-500">Premium Vendor</p>
            </div>
            <img
              alt="Vendor avatar"
              className="h-10 w-10 rounded-full border-2 border-[#dbe1ff] object-cover"
      ...
      <main className="min-h-[calc(100vh-4rem)] bg-[#f6f6f8] p-4 md:ml-64 md:p-8">
        <div className="mx-auto max-w-5xl">
          <form id="product-edit-form" onSubmit={onSubmit}>
            ...
            {!loading && !sourceProduct ? <p className="mb-4 text-sm text-amber-700">Product {productId} was not found in vendor listing results.</p> : null}
            ...
            {sourceProduct ? (
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div className="rounded-xl bg-white p-8 shadow-sm">
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center gap-3">
                            <input
                              className="flex-1 rounded-lg border-none bg-[#f0f2f4] px-4 py-3 text-xl font-bold focus:ring-2 focus:ring-[#135bec]/20"
                              onChange={(event) => setForm((prev) => ({ ...prev, stock_quantity: event.target.value }))}
                              type="number"
                              value={form.stock_quantity}
                            />
                            <div className="rounded-full bg-green-100 px-3 py-1 text-[10px] font-bold uppercase text-green-800">
                              {form.availability ? "In Stock" : "Out"}
                            </div>
                          </div>
                        </div>
                        <div className="space-y-2">
                ...
                <div className="space-y-8">
                  ...
                  <section className="rounded-xl bg-white p-8 shadow-sm">
                    <h3 className="mb-6 flex items-center gap-2 text-lg font-bold">
                      <Label className="text-[#135bec]" size={18} />
                      Organization
                    </h3>
                    <div className="space-y-6">
                      <div className="space-y-2">
                  ...
                  <section className="rounded-xl bg-gradient-to-br from-[#135bec] to-blue-700 p-8 text-white shadow-xl">
                    ...
                    <p className="text-xs leading-relaxed text-white/90">
                      This product is in your top revenue generators. Keep stock above 100 units to maintain momentum.
                    </p>
                  </section>
                </div>
              </div>
