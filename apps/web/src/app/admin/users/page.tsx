...
const users = [
  { name: "Dawit Solomon", email: "dawit.s@ethioazure.com", role: "Shopper", status: "Active", joined: "Oct 12, 2023", lastActive: "2 mins ago" },
  { name: "Selam Electronics", email: "sales@selamelectro.et", role: "Vendor", status: "Active", joined: "Jan 05, 2023", lastActive: "1 hour ago" },
  { name: "Martha Tekeste", email: "martha.t@admin.spendsense.et", role: "Admin", status: "Active", joined: "Mar 18, 2022", lastActive: "Now" },
  { name: "Abel Girma", email: "abel.girma@mail.et", role: "Shopper", status: "Suspended", joined: "Jun 22, 2023", lastActive: "14 days ago" },
];

export default function AdminUsersPage() {
  return (
    <AdminShell activeTab="users" subtitle="Manage permissions, monitor activity, and moderate user access." title="Platform Users">
