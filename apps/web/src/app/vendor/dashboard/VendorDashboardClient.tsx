...
export default function VendorDashboardClient({
  ...
  const [profileName, setProfileName] = useState(initialProfile?.full_name || initialProfile?.email || "Vendor Team");
  ...
  return (
    <main className="min-h-[calc(100vh-4rem)] p-4 md:ml-64 md:p-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-slate-500">Welcome back. Here's what's happening with your store today.</p>
        {vendorId ? (
